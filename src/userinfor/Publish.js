...
import { Text, View ,StyleSheet, TouchableOpacity,ToastAndroid,Dimensions, ActivityIndicator} from 'react-native'
        ...
        return (
            <View style={styles.content}>
                ...
                <View style={styles.page}>
                    ...
                    <Text style={{paddingTop:10*s,marginLeft:65*s}}>第{this.state.page}页</Text>
